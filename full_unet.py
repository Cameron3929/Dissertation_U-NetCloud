...
Original file is located at
    https://colab.research.google.com/drive/1RsqocU083DJODAMRCZ2bE6iFrZhUtYAl
"""

# === Script A: Full U-Net (Skip=ON, Double-Conv=ON) ===
...
class CloudDataset(Dataset):
    def __init__(self, base_path):
        ...
        assert len(self.r)==len(self.g)==len(self.b)==len(self.gt), "File count mismatch"
...
# 5️⃣ Model Definition (Full U-Net)
class UNet(nn.Module):
    def __init__(self):
        ...
        self.d3 = C(512+256,256)
        self.d2 = C(256+128,128)
        self.d1 = C(128+ 64, 64)
...
# 6️⃣ Prepare DataLoader (first 1050 samples)
